...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/connector2.git
cd connector2
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/fss2release.git
cd fss2release
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/gx.git
cd gx
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/hhucompany.git
cd hhucompany
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/jlwh.git
cd jlwh
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/watermeter.git
cd watermeter
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/sxocx.git
cd sxocx
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/certification.git
cd certification
...
cd %~dp0..\
git.exe clone  --recursive       --progress -v   git@li.aihlp.com:li/solution.git
cd solution
